...
client = OpenAI(
    api_key = "xxxx",
    base_url = "http://api.com/v1" #your own api url
)

function_map = {
    "get_weather": get_weather
}
def run_conversation(user_query): #Here is an updation that your need put user_query to let the streamlit get input
    MODEL = "chatglm3-6b"
    messages = [
            # {"role": "user", "content": "How's the weather like today in Beijing? Do you have any suggestions about clothing?"},
